...
|X1-X2|+|Y1-Y2| > width/2 :- sprite((X1, Y1), altar), sprite((X2, Y2), gem).

% Distance between gems must be reasonably large
|X1-X2|+|Y1-Y2| > width/2 :- X1 != X2, sprite((X1, Y1), gem), sprite((X2, Y2), gem).
|X1-X2|+|Y1-Y2| > width/2 :- Y1 != Y2, sprite((X1, Y1), gem), sprite((X2, Y2), gem).
